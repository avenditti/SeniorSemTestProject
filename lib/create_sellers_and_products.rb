...
# Products owned by Mary
 ...
 Mozilla, Gnome, and Ruby on Rails are now using Distributed Version Control S
ystems (DVCS)
 ...
 description:
 %{<p>
 Learn CoffeeScript programming with the three most popular web technologies a
round.
 </p>},
 ...
 JavaScript. Now, for the first time, programmers have an alternative that doe
sn't
 add an extra layer of abstraction or require plugins. CoffeeScript provides
all
 of JavaScript's functionality wrapped in a cleaner, more succinct syntax th
at
